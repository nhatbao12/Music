   ...
   songs: [
      {
         ...
         author: 'GREY D & ORANGE',
         path: './music/Song01.mp3',
         image: './image/image0.jpg'
      },
      {
         title: 'TÌNH ĐÃ XA MỜ',
         author: ' NGUYÊN. FT. SETH',
         path: './music/Song02.mp3',
         image: './image/image1.jpg'
      },
      {
         title: 'CUỘC ĐIỆN THOẠI',
         author: 'TÙA & CM1X',
         path: './music/Song03.mp3',
         image: './image/image2.jpg'
      },
      {
         title: 'SỢ EM BIẾT RẰNG ANH CÒN YÊU EM',
         author:  'JUUN D x Freak D',
         path: './music/Song04.mp3',
         image: './image/image3.jpg'
      },
      {
         title: 'Họ Yêu Ai Mất Rồi',
         author: 'Doãn Hiếu',
         path: './music/Song05.mp3',
         image: './image/image4.jpg'
      },
      {
         title: 'Ánh Sao Và Bầu Trời',
         author: 'T.R.I x Cá',
         path: './music/Song06.mp3',
         image: './image/image5.jpg'
      },
      {
         title: 'VINARAP',
         author: 'JB LONG',
         path: './music/Song07.mp3',
         image: './image/image6.jpg'
      },
      {
         title: 'NHƯ ANH ĐÃ THẤY EM',
         author: 'PhucXp ft. Freak D',
         path: './music/Song08.mp3',
         image: './image/image7.jpg'
      },
      {
         title: 'Chuyện Đôi Ta',
         author: 'Freak D Lofi Ver',
         path: './music/Song09.mp3',
